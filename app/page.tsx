  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section id="about" className="py-16 md:py-24 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">About {clinicInfo.name}</h2>
      ...
      <section id="why" className="py-16 md:py-24 bg-primary/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Why Choose {clinicInfo.name}</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
      ...
      <section id="contact" className="py-16 md:py-24 bg-gradient-to-br from-primary/10 via-background to-secondary/10 text-foreground">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            {/* Location */}
            <a href={clinicConfig.googleMapsLink} target="_blank" rel="noopener noreferrer" className="bg-card border border-border text-foreground p-6 rounded-lg text-center hover:shadow-lg transition-shadow">
