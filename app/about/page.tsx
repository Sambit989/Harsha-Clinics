    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-12 md:py-16 bg-primary/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">About {clinicInfo.name}</h1>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-muted-foreground mb-4 leading-relaxed">
            Our clinic was founded with a simple yet powerful mission: to provide accessible, affordable, and high-quality healthcare to families in our community. Located in {clinicInfo.address.area}, we&apos;ve grown to become a trusted healthcare destination in {clinicInfo.address.city}.
          </p>
          <p className="text-lg text-muted-foreground mb-4 leading-relaxed">
            Our team of experienced healthcare professionals is dedicated to understanding each patient&apos;s unique needs and providing personalized care. We believe that healthcare should never compromise on quality, even when it&apos;s affordable.
          </p>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Today, with a {clinicInfo.rating}★ rating from over {clinicInfo.reviews} patients, we continue our mission to be the most trusted healthcare provider in the neighborhood.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-primary text-primary-foreground">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg opacity-90 mb-8">Join thousands of satisfied patients who trust {clinicInfo.name} for their healthcare needs</p>
